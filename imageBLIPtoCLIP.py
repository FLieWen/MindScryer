...
# 修改BLIP-2模型加载路径
blip2_local_path = "blip2-opt-2.7b"

processor = Blip2Processor.from_pretrained(blip2_local_path)
model = Blip2ForConditionalGeneration.from_pretrained(
    blip2_local_path, torch_dtype=torch.float16
)
model.to(device)
...
transformer = CLIPTextModel.from_pretrained("clip-vit-large-patch14")
